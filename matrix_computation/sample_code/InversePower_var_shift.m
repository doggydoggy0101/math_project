...
function [sigma_new, ev, iter] = InversePower_var_shift(sigma, mtx_A, iter_max, tol)
...
lambda_tmp = 1 / lambda_old + sigma;
rsdl       = norm( mtx_A * ev - lambda_tmp * ev );
% -------------
% the main loop
% -------------
