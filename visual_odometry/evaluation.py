...
def evaluate(result_dir, alignment, sequences):

    ground_truth_dir = "dataset/poses/"

    KittiEvalOdom().eval(gt_dir=ground_truth_dir, result_dir=result_dir, alignment=alignment, seqs=sequences)
