function [H, score, inliersIndex] = compute_homography(matchedPoints1, matchedPoints2)

    [H, inliersLogicalIndex] = estgeotform2d(matchedPoints1, matchedPoints2, "projective", MaxNumTrials=1e3, MaxDistance=4, Confidence=90);
